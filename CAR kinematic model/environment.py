...
class Parking1():
    def __init__(self, car_pos):
        ...
        self.cars = {1 : [35,20], 7 : [65,20], 13: [75,20], 19: [95,20],
                     2 : [35,32], 8 : [65,32], 14: [75,32], 20: [95,32],
                     3 : [35,44], 9 : [65,44], 15: [75,44], 21: [95,44],
                     4 : [35,56], 10: [65,56], 16: [75,56], 22: [95,56],
                     5 : [35,68], 11: [65,68], 17: [75,68], 23: [95,68],
                     6 : [35,80], 12: [65,80], 18: [75,80], 24: [95,80]}
